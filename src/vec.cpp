...
namespace HLStrafe
{
	...
	double& vec2d::operator[](std::size_t idx)
	{
		assert(idx == 0 || idx == 1);
	...
	const double& vec2d::operator[](std::size_t idx) const
	{
		assert(idx == 0 || idx == 1);
	...
	double& vec::operator[](std::size_t idx)
	{
	...
	const double& vec::operator[](std::size_t idx) const
	{
		assert(idx == 0 || idx == 1 || idx == 2);
